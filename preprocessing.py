from modules.utils import read_labels_to_file, extract_frames, read_labels_to_file_flow
...
# TODO: generate optical flow and label pair
read_labels_to_file_flow(remote_path, fps, 1, 51, 'train')
read_labels_to_file_flow(remote_path, fps, 51, 61, 'vali')
