...
class Dataset:
    ...
    def load_split(self, features, split, feature_type="X", sample_rate=1):
        ...
        if self.activity == None:
            ...
            file_train = open(
                self.base_dir + "splits/{}/{}/{}/train.txt".format(self.name, self.activity, split)).readlines()
            file_test = open(
                self.base_dir + "splits/{}/{}/{}/test.txt".format(self.name, self.activity, split)).readlines()
